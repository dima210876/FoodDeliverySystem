...
export const changeDeliveryOrganizationInfo = (organizationId, name, accountNumber, phone, address, latitude, longitude) => (dispatch) => {
    return changeInfoService.changeDeliveryOrganizationInfo(organizationId, name, accountNumber, phone, address, latitude, longitude).then(
        (response) => {
            dispatch({
