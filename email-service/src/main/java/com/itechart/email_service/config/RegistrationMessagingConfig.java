...
public class RegistrationMessagingConfig
{
    ...
    @Bean
    public Queue registrationMessagingQueue() { return new Queue(QUEUE); }

    @Bean
    public TopicExchange exchange() { return new TopicExchange(EXCHANGE); }

    @Bean
    public Binding registrationMessagingBinding(TopicExchange exchange)
    {
        return BindingBuilder.bind(registrationMessagingQueue()).to(exchange).with(ROUTING_KEY);
    }
